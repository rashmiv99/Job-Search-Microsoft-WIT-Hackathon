        ...
        <Dialog open={props.newJobModal} fullWidth>
            ...
            <DialogContent>
                <Grid container spacing={2}>
                    <Grid item xs={6}>
                        <FilledInput onChange={handleChange} name="title" value={jobDetails.title} lautoComplete="off" placeholder="Job title *" disableUnderline fullWidth />
                    </Grid>
                    <Grid item xs={6}>
                    ...
                    <Grid item xs={6}>
                        <Select onChange={handleChange} name="education" value={jobDetails.education} fullWidth disableUnderline variant="filled">
                    ...
                    <Grid item xs={6}>
                        <Select onChange={handleChange} name="experience" value={jobDetails.experience} fullWidth disableUnderline variant="filled">
